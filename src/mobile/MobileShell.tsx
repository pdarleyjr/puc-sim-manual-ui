...
export default function MobileShell({ mode }: MobileShellProps) {
  ...
  return (
    <div className="md:hidden mobile-fullscreen bg-[#0f141a] text-slate-100 flex flex-col">
      ...
      <div id="mobile-body" className="flex-1 overflow-hidden flex items-center justify-center">
        <div className="text-center p-8">
          <h1 className="text-2xl font-bold mb-4">Mobile Panel UI</h1>
          <p className="text-sm opacity-70 mb-4">Active Tab: {activeTab}</p>
          <p className="text-sm opacity-70">Page: {activePage}</p>
        </div>
      </div>
